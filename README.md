...
- Default location: Toronto
    <br>- Search bar allows user to enter the required city
    <br>- Information will not be updated if the city name is entered incorrectly (city doesn't exist in the API database)
...
![odesa](screenshots/odesa.png)
![kyoto](screenshots/kyoto.png)
